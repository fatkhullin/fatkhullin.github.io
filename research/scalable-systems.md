...
<div style="display:flex; gap:20px; align-items:flex-start; flex-wrap:wrap; margin:12px 0;">
  ...
  <div style="flex:1 1 60%; min-width:300px;">
    ...
    <ul style="margin-top:6px;">
      ...
      <li>I identify the limitations of EF21 in stochastic settings (see Figure 2) and propose a theoretically grounded and practically relevant momentum method: momentum provably improves error feedback with stability benefits and linear speed-ups
